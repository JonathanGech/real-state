...
class FooterTablet extends StatelessWidget {
	...
	Widget build(BuildContext context) {
      ...
      children: [
        Padding(
          padding: CustomUi.defPadding(hr: 50.w, vr: 0),
          child: Row(
        ...
        Container(
          ...
          width: w,
          child: Padding(
            padding: CustomUi.defPadding(hr: 100.w, vr: 20.h),
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              children: [
                Row(
                 ...
                 Row(
                  children: [
                    SvgButtons.tablet(assetPath: 'assets/icons/facebook.svg'),
                    SvgButtons.tablet(assetPath: 'assets/icons/youtube.svg'),
                    SvgButtons.tablet(assetPath: 'assets/icons/linkedin.svg'),
                    SvgButtons.tablet(assetPath: 'assets/icons/tiwtter.svg'),
                  ],
                )
              ],
            ),
